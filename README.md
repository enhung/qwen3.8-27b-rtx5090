...
> published by GitHub Actions; container-local checks and the external GPUtw
> authenticated proxy matrix pass. Hermes continuation acceptance remains
> pending. The build and live
